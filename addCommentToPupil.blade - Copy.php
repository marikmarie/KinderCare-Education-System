          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">KCDS</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
          ...
          <div class="register-box m-auto col-md-8">
            <div class="card card-outline card-success">
              <div class="card-header text-center">
                <h2>Comment on {{$pupil->firstname }} {{$pupil->lastname}}'s performace in {{$assignment->name}}</h2>
              </div>
              <div class="card-body">
                <!-- <p class="login-box-msg">Register a new Pupil</p> -->


                <form method="POST" action="{{route('reports.assignment.pupil.comment')}}">
                    @csrf
                    <div class="form-group mb-3">
                        <input type="text" name="assignmentId" value="{{$assignment->id}}" hidden>
                          <input type="hidden" name="pupilId" value="{{$pupil->id}}">
                        <label for="">Comment</label>
                        <input type="text" name="comment" required placeholder="Enter comment" class="form-control"/>
                       </div>
                       ...
                       <div class="row">
                         ...
                         <!-- /.col -->
                         <div class="col-12">
                           <button type="submit" class="btn  btn-block btn-primary btn-success">Submit</button>
                         </div>
                         <!-- /.col -->
                       </div>
